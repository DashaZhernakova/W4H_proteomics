...
feature1_list <- as.character(read.delim(prot_list_fname, as.is = T, check.names = F, sep = "\t", header = F)$V1)
...
cat("File 1: ", fname1, "\n")
cat("File 2: ", fname2, "\n")
cat ("Covariates: ", colnames(covariates)[! colnames(covariates) %in% c("ID", "SampleID", "TP", "phase")], "\n")
